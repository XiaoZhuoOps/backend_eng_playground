...
import (
	...
	"backend_eng_playground/internal/api"
	"backend_eng_playground/internal/registry"
	_ "backend_eng_playground/scenarios/cache_inconsistency" // Import for side-effect of registration
