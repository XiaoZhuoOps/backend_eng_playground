...
type user struct {
	...
	Name      field.String // User name (advertiser or company name)
	Type      field.Int32  // User type: 0=individual, 1=enterprise, 2=agency
	Region    field.String // User region/location
	Email     field.String // Contact email
	Phone     field.String // Contact phone
	Status    field.Int32  // User status: 0=inactive, 1=active, 2=suspended
